...
//go:generate bash -c "(egen -i $GOPATH/src/github.com/infobloxopen/themis/jparser/errors.yaml > $GOPATH/src/github.com/infobloxopen/themis/jparser/errors.go) && gofmt -l -s -w $GOPATH/src/github.com/infobloxopen/themis/jparser/errors.go"
