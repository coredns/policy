...
func TestInsert32(t *testing.T) {
	...
	for i := 0; i <= math.MaxUint8; i++ {
		r = r.Insert(uint32(i), 32, uint8(i))
	}
...
func TestInplaceInsert32(t *testing.T) {
	...
	r = nil
	for i := 0; i <= math.MaxUint8; i++ {
		r = r.InplaceInsert(uint32(i), 32, uint8(i))
	}
	assertTree32(r, TestTree32BigTreeInsertions,
	...
	r = nil
	for i := 0; i < len(inv32); i++ {
		r = r.InplaceInsert(uint32(inv32[i])<<24, 32, uint8(inv32[i]))
	}
	assertTree32(r, TestTree32BigTreeInvertedInsertions,
...
func wrapUint8(n uint8) *uint8 {
	return &n
}

func assertTreeMatch(v uint8, ok bool, e *uint8, desc string, t *testing.T) {
	if e == nil {
		if ok {
